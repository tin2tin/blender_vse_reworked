...
[("Sequencer",
  ...
  {"items":
   [("sequencer.select_all",
    ...
    ("sequencer.select_current_frame",
     {"type": 'F', "value": 'PRESS'},
     {"properties":
      [("extend", 'FALSE'),
       ],
    ...
    ("sequencer.view_channel", {"type": 'A', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ("sequencer.view_channel", {"type": 'S', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ("sequencer.select_current_frame",
